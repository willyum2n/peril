...
class gsp_peril_layoutsmain_gsp extends GroovyPage {
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('layoutTitle','g',10,['default':("Captiosus Games")],-1)
})
...
public static final long LAST_MODIFIED = 1421784345000L
